// ===============================================
// OVER/THROUGH GAME - With Firebase Integration
// ===============================================

// ================= GAME CONFIGURATION =================
const CONCEPT_TYPE = 'Spatial Concepts';
const GAME_NAME = 'melepasi / melalui';
const GAME_KEY = 'melepasi_/_melalui';    // ⚠️ UNIQUE KEY (with underscores)
...
const questions = [
  {
    label: "melepasi",
    question: "Mana yang melepasi?",
    correctImg: "../../../assets/images/over.png",
    options: [
      { answer: "wrong", img: "../../../assets/images/through.png" },
      { answer: "correct", img: "../../../assets/images/over.png" },
    ]
  },
  {
    label: "melalui",
    question: "Mana yang melalui?",
    correctImg: "../../../assets/images/through.png",
    options: [
      { answer: "wrong", img: "../../../assets/images/over.png" },
      { answer: "correct", img: "../../../assets/images/through.png" },
    ]
  }
];
