// ===============================================
// QUALITATIVE CONCEPTS - big / small
...
const GAME_NAME = 'panjang / pendek';
const GAME_KEY = 'panjang_/_pendek';
...
// ================= QUESTIONS DATA =================
const questions = [
  { question: "Mana lebih panjang?", correctAnswer: "long.png" },
  { question: "Mana lebih pendek?", correctAnswer: "short.png" }
];
...
document.addEventListener('DOMContentLoaded', async () => {
  console.log("🎮 big/small Game loaded!");
...
console.log('✅ Qualitative Concepts (big/small) game with LOCKED score system loaded!');