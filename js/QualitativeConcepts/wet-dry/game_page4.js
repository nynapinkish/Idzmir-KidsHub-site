...
// ================= QUESTIONS DATA =================
const questions = [
  { question: "Mana lebih basah?", correctAnswer: "wet.png" },
  { question: "Mana lebih kering?", correctAnswer: "dry.png" }
];
...
async function checkGameStatus() {
  try {
    ...
    const qualitativeProgress = conceptProgress[CONCEPT_TYPE] || {};
...
console.log('✅ Game with LOCKED score system loaded!');