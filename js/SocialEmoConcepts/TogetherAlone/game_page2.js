// ===============================================
// SOCIAL/EMOTIONAL CONCEPTS - Bersama/Bersendirian
// FIXED: Score properly saves to Firebase
// ===============================================

// ================= GAME CONFIGURATION =================
const CONCEPT_TYPE = 'Social/Emotional';
const GAME_NAME = 'bersama / bersendirian';
const GAME_KEY = 'bersama_/_bersendirian';
...
document.addEventListener('DOMContentLoaded', async () => {
  console.log("🎮 Together/Alone Game loading...");
  ...
  const questions = [
    {
      ...
      options: [
        { answer: "together", img: "../../../assets/images/together.png" },
        { answer: "alone", img: "../../../assets/images/alone.png" }
      ]
    },
    {
      label: "sendiri",
...
console.log('✅ Together/Alone game loaded with FIXED score saving!');