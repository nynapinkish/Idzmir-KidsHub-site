...
document.addEventListener("DOMContentLoaded", async () => {
  console.log('========================================');
  console.log('🎮 APPLE SORTING GAME - DEBUG MODE');
  console.log('========================================');
  ...
  console.log('\n🎮 Initializing game...');
  const gameStarted = await initializeGame('Relational Concepts', 'same / different / apple', 4);
  ...
  console.log('\n✅ Apple Sorting Game fully loaded!');
  console.log('========================================\n');
});