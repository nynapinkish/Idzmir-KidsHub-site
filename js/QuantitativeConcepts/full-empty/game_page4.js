// ===============================================
// QUANTITATIVE CONCEPTS - penuh / kosong
...
const GAME_NAME = 'penuh / kosong';
const GAME_KEY = 'penuh_/_kosong';
...
// ================= QUESTIONS DATA =================
const questions = [
  { question: "Yang manakah penuh?", correctAnswer: "full.png" },
  { question: "Yang manakah kosong?", correctAnswer: "empty.png" },
];
...
async function showAlreadyPlayedScreen() {
  ...
  // ⚠️ HIDE GAME ELEMENTS (Quantitative-specific) AFTER updating score
...
document.addEventListener('DOMContentLoaded', async () => {
  console.log("🎮 penuh/kosong Game loaded!");
...
console.log('✅ penuh/kosong game with LOCKED score system loaded!');