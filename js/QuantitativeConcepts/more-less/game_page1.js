// ===============================================
// QUANTITATIVE CONCEPTS - banyak / kurang
// With Firebase Integration (First Attempt Only)
// FIXED VERSION - Score persists after refresh
// ===============================================

// ================= GAME CONFIGURATION =================
const CONCEPT_TYPE = 'Quantitative Concepts';
const GAME_NAME = 'banyak / kurang';
const GAME_KEY = 'banyak_/_kurang';    // ⚠️ UNIQUE KEY (with underscores)
